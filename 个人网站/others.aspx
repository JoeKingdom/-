    ...
    <table class="auto-style1">
        ...
        <tr>
            <td class="auto-style3" style="text-align: center">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:mywebsiteConnectionString %>" SelectCommand="SELECT [No], [Name], [Color], [Quality], [Number], [Price] FROM [peijian]"></asp:SqlDataSource>
            </td>
        </tr>
        <tr>
