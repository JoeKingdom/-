...
public partial class manageearphones : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = " INSERT INTO earphone" + " ([No],[Name],[Color],[Quality],[Usb],[Type],[Number],[Price])" + " VALUES(@No,@Name,@Color,@Quality,@Usb,@Type,@Number,@Price)";
        ...
        cmd.Parameters.AddWithValue("@Usb", TextBox5.Text);
